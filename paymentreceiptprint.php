...
<div class="row">
    <div class="col-lg-10 col-md-8 col-sm-8 col-xm-6">
          ...
          <h1 class="h6 mb-0 text-gray-800 font-weight-bold ">PAYMENT RECEIPT PRINTING</h1>  
    </div>
    </div>
...
<div class="card-title">TRANSACTION PAYMENT RECEIPT</div>
...
<td>Successful</td>
<td>Approved</td>
<td class="text-left"><a href="#" class="btn btn-primary btn-success btn-sm">Print </a></td>
</tr>
</tbody>
</table>
</div>
